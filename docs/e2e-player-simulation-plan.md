...
- [ ] **P10-02** [LIVE] M — Soak and capacity: 50, 200 and 500 bots across the starter zones (and Reshanta for PvP)
  ...
  **In progress, not accepted:** capacity identities/options now support 1,000 subjects without MAC/name
  ...
  The finite quest driver passes a ten-subject/twenty-minute diagnostic; repeatable PvP is under validation.
  Remaining resource coordination, telemetry
  ...
  PvP reward assertions use an independent ordinary-rate solo-soldier oracle, including the native
  fifth-opponent-kill reduction to 1 AP, rank changes and victim AP loss. Repeated PvP resurrection/return
  has a diagnostic driver under validation: ordinary medium-Kisk item use/binding, real deaths,
  ...
  Kisks cannot overwrite the subject's evidence. Repeated LIVE PvP proof is still pending.

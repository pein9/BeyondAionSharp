...
- [ ] **P10-02** [LIVE] M — Soak and capacity: 50, 200 and 500 bots across the starter zones (and Reshanta for PvP)
  ...
  **In progress: 50 accepted; 200/500 pending.** Capacity identities/options now support 1,000 subjects without MAC/name
  ...
  Replacement matrix-d 200 passed natural heap preflight and began its workload
  at 2026-09-20 15:55:26 UTC; its 500 stage has not started. Concurrent diagnostic
  ...
  preserved, respawn changed, or missing credit accepted. Scaled replay is pending.

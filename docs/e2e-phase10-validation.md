...
## P10-10 second clean Full candidate

`p10-accept-05` ran the same complete supported Breadth selection at revision
`da3b1c7c9bda490893c4dd7149e93c69e6de2ab9`, with two SIM shards and Host bot
execution. It exited zero after 14,492.546 seconds and passed 119 scenarios with
...
catalog sweeps reproduced candidate 1 exactly: skills 5,033/5,033; trade 2,290
rows with 1,304 passed, 816 unreachable and 170 inactive; teleport 284 with 238
passed and 46 unreachable; bind 129 with 89 passed and 40 unreachable; craft
12,494/12,494; gather 756 with 374 passed and 382 unreachable. Inactive trade
content remained reported rather than enabled.
...
Packet coverage passed with the same complete-Breadth identities as candidate 1:
SIM observed 104/186 client sends and 111/238 structured server decodes; LIVE
observed 100/186 and 111/238. The E6 exchange identities remained present. All
16 planned Coverlet processes were collected with zero evidence issues. Their
compatible union measured 95,554/267,950 GameServer lines (35.661%) and
23,765/103,697 branches (22.918%). This small execution-coverage variation at
the identical code revision is retained as measured evidence; it did not change
the functional, quest, packet or report verdict.

Immutable SHA-256 receipts:

- `report.json`: `74407e7657320577c56d76dac38cb4004b6f71787ec12bb0066952f53a3fad07`
- `packet-coverage-comparison.json`: `33e71ad3e54f81ac327ff7dc31834ef0a7cb49b2a44f591d3e0cc546f548b650`
- `quest-coverage.json`: `20ad1d97a1434928d15e9303695275e3ec32ef407abea29d7e4c3bda765d35d6`

The Full-history ledger records attempt 05 as green with every selected LIVE
...
## P10-10 fourth clean Full candidate

`p10-accept-07` ran the same complete supported Breadth selection at revision
`05a073c17cd642e1eec8e27060fc1eb2304683df`, with two SIM shards and Host bot
execution. It exited zero after 14,337.832 seconds and passed 119 scenarios with
zero failed, skipped or flaky outcomes. B2F and S5 again passed on their first
attempts. Quest coverage again passed with 58 SIM and 60 LIVE completions. The
catalog sweeps reproduced the prior candidates exactly: skills 5,033/5,033;
trade 2,290 rows with 1,304 passed, 816 unreachable and 170 inactive; teleport
...
Packet coverage passed with the same complete-Breadth identities as candidates
1-3: SIM observed 104/186 client sends and 111/238 structured server decodes;
LIVE observed 100/186 and 111/238. The E6 exchange identities remained present.
All 16 planned Coverlet processes were collected with zero evidence issues. Their
compatible union measured 95,571/267,950 GameServer lines (35.667%) and
23,769/103,697 branches (22.922%). The execution-coverage variation is retained
as measured timing/path evidence; the functional, quest, packet and report
verdicts are unchanged.

Immutable SHA-256 receipts:

- `report.json`: `d86bc43b0c72a670775088c34a0c36970b1115d4b341598b277417b7d812ad96`
- `packet-coverage-comparison.json`: `bd677b3d4dd8afa98ae16265514605db5aab562fc029cc50bae939131c203f23`
- `quest-coverage.json`: `faeac2d7dccded376d0c02baa3a67e7a6ee746fee9c3dd06d245730e74e5e9ac`

The Full-history ledger records attempt 07 as green with every selected LIVE
scenario passed and no quarantine. Full-ledger promotion also passed against the
...
## P10-10 first clean Full candidate after the reset

`p10-accept-09` ran the complete supported Breadth selection at revision
`12bce1d1c3bd2758f5c6c3d36ced34518d200b12` with two SIM shards, Host bot
execution and pipe-backed output. This avoided attempt 08's Windows Docker PTY
failure without changing the workload or retry policy. The run passed after
13,961.356 seconds with 119 passed, 0 failed, 0 skipped and 0 flaky outcomes.
Full-ledger promotion also passed against the same revision.

All catalog totals match the earlier clean candidates: skills 5,033/5,033;
trade 2,290 rows with 1,304 passed, 816 unreachable and 170 inactive; teleport
284 with 238 passed and 46 unreachable; bind 129 with 89 passed and 40
unreachable; craft 12,494/12,494; and gather 756 with 374 passed and 382
unreachable. Both geodata displacement checks passed. Quest coverage passed
with 58 SIM and 60 LIVE completions. Packet coverage passed with SIM 104/186
client opcodes and 111/238 structured server decodes, and LIVE 100/186 and
111/238. The 16 Coverlet processes measured 95,580/267,950 lines and
23,820/103,697 branches.
...
subjects remained sequential with peak one. Character transfer was not selected,
executed, deferred or counted: D20 makes it inapplicable to this single-server
emulator, so it is not an acceptance gate.

Immutable SHA-256 receipts:

- `report.json`: `5dee2c7d25499e38b864a31071f589e5e467cb980134437134fdc10df4cb417b`
- `packet-coverage-comparison.json`: `98c8824f2e81a40bc889f13eda410fcd0b9889a2ddae0fe78ff1174a4dda67de`
- `quest-coverage.json`: `7244bd4af083a83ae1c7304e9ddc1dbc9cfcb88f271a03cd69b52396f20266ee`

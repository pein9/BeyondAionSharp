...
| Quest selection and execution | NI-07 in progress | Q4I completes 27 template quests with GM level/items/teleports and omits custom campaigns. A separate Docker SIM checkpoint now completes Q2000 and Q2101–Q2103 on one ordinary Priest with checked walking, natural combat and packet-confirmed quest state. This is 4/41, not the complete journey; the remaining template and custom operations still need integration. |
...
- [ ] **NI-07 — Forty-one-quest execution.** Support the custom campaigns and
  ...
  creates a Priest and completes Q2000/Q2101/Q2102/Q2103 naturally on the same
  character, including four ordinary Priest combat kills and post-kill rests.
  ...
  the four-quest checkpoint nor the endpoint rule satisfies the 41-quest TODO.

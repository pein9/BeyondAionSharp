...
/// <summary>
/// Java parity: network/aion/serverpackets/SM_ATTACK_STATUS. Faithful 1:1 port. Class name kept PascalCase
/// per the C# packet convention; nested TYPE/LOG mirror Java's nested enums exactly.
/// </summary>
/// <remarks>

...
public class EnchantService
{
    ...
    public static int GetEquipBuff(Item item)
    {
        int[] skills = item.GetItemTemplate().GetExceedEnchantSkill() switch
        {
            ...
            ExceedEnchantSkillSetType.RANK1_SET2_MAGICAL_SHOULDER => new int[] { 13104, 13094, 13102 },
            ...
            ExceedEnchantSkillSetType.RANK1_SET2_PHYSICAL_SHOULDER => new int[] { 13104, 13094, 13102 },
            ...
            ExceedEnchantSkillSetType.RANK2_SET1_MAGICAL_SHOULDER => new int[] { 13088, 13105, 13103 },
            ...
            ExceedEnchantSkillSetType.RANK2_SET1_PHYSICAL_SHOULDER => new int[] { 13091, 13105, 13103 },

...
public interface IExpirable
{
    ...
    void OnBeforeExpire(Aion.GameServer.Model.GameObjects.Players.Player player, int remainingMinutes) { }

    // Java parity: onExpire(Player)
    void OnExpire(Aion.GameServer.Model.GameObjects.Players.Player player);

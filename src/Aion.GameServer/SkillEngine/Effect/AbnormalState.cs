...
public enum AbnormalState
{
    ...
    ANY_STUN = STUN | STUMBLE | STAGGER | SPIN,
    CANT_ATTACK_STATE = ANY_STUN | PARALYZE | SLEEP | FEAR | OPENAERIAL | PULLED | SANCTUARY | CONFUSE,
    STANCE_OFF = ANY_STUN | PARALYZE | FEAR | OPENAERIAL | PULLED | SANCTUARY | CONFUSE,
    CANT_MOVE_STATE = ANY_STUN | PARALYZE | SLEEP | ROOT | OPENAERIAL | PULLED | SANCTUARY,
    DISMOUNT_RIDE = ANY_STUN | PARALYZE | SLEEP | ROOT | OPENAERIAL | PULLED | FEAR | SNARE | DEFORM | CONFUSE,
    AUTOMATICALLY_STANDUP = PARALYZE | SLEEP | FEAR | STUN | STAGGER | OPENAERIAL | SPIN | DEFORM | PULLED | CONFUSE,
    CANCEL_ITEM_USE = ANY_STUN | PARALYZE | SLEEP | CHARM | FEAR | CONFUSE | PETRIFICATION | OPENAERIAL | PULLED,
}

...
/// <summary>
/// Java parity: configs/main/RatesConfig (Neon). SCREAMING_SNAKE field names + [Property] keys/defaults bound at
/// boot by <see cref="ConfigurableProcessor"/> from config/main/rates.properties. Each float[] is parsed from a
/// comma-separated default ({regular, premium, ...} per membership level) via the ArrayTransformer.
/// </summary>

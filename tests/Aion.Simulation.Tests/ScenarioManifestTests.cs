...
public sealed class ScenarioManifestTests
{
	...
	public void CheckedInManifestIsTheSharedModeAndTierSource()
	{
		...
		Assert.Equal(["B4", "B3", "B2F", "B2", "O1", "NI-01", "NI-02", "NI-03", "L0", "M1", "M6", "C1", "Q1", "Q2", "Q3", "Q4P", "Q4I", "E1", "E2", "E3", "E4", "E5", "E6", "E7", "CAPITAL", "S1", "S2", "S3", "S4", "S5", "S6", "S7", "G1", "G2", "G3", "G4", "G5", "G6", "E8", "E9", "E10", "E11", "L1", "L2", "L3", "L4", "L5", "L7", "connect", "canaries"],

	...
	TimeSpan ReentryDelay)
{
	...
	public static LiveBotOptions Parse(string[] args)
	{
		...
		if (scenarios.Any(scenario => scenario is "NI-01" or "NI-02" or "NI-03" or "NI-04" or "NI-05") && (scenarios.Length != 1 || bots != 1))
		...
		if (values.ContainsKey("decision-view-seconds") && !scenarios.Any(scenario => scenario is "NI-02" or "NI-03" or "NI-04" or "NI-05"))
			throw new ArgumentException("--decision-view-seconds requires --scenario NI-02, NI-03, NI-04, or NI-05.");
